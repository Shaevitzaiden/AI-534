...
def preprocess(data_train, data_dev, method="GloVe 3"):
...
def split_words(word, ge):
    word_options = []
    # for words in parse(word, meaningful_word_list):
    for words in parse(word):
